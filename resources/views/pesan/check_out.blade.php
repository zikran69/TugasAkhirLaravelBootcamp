...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a href="{{ url('home') }}" class="btn btn-primary"><i class="ri-arrow-left-line"></i> Kembali</a>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h3><i class="ri-shopping-cart-line"></i> Check Out</h3>
                    @if(!empty($pesanan))
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ url('check-out') }}/{{ $pesanan_detail->id }}" method="post">
                                        @csrf
                                        {{ method_field('DELETE') }}
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin akan menghapus data ?');"><i class="ri-delete-bin-2-line"></i></button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('konfirmasi-check-out') }}" class="btn btn-success" onclick="return confirm('Anda yakin akan Check Out ?');">
                                        <i class="ri-shopping-cart-line"></i> Check Out
                                    </a>
                                </td>
                            </tr>
                        </tbody>
