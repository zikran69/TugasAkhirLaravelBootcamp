...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a href="{{ url('history') }}" class="btn btn-primary"><i class="ri-arrow-left-line"></i> Kembali</a>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong> silahkan lakukan pembayaran dengan : </h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
                    <h3><i class="ri-shopping-cart-line"></i> Detail Pemesanan</h3>
                    @if(!empty($pesanan))
